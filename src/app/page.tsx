...
const notices = [
  {
    ...
    content: "O período de renovação de matrículas para o ano letivo de 2026 começa na próxima segunda-feira.",
  },
  {
    id: 2,
    ...
    content: "Convidamos todos para a primeira reunião do ano. Pauta: Apresentação do calendário escolar.",
  },
  {
    id: 3,
    ...
    content: "Alunos interessados em apresentar projetos na Feira de Ciências devem procurar seus professores.",
  },
];
